    ...
    <div class="item_fields">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <?php $uploadPath = 'administrator' . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_db8download' . DIRECTORY_SEPARATOR . 'com_db8download' . DIRECTORY_SEPARATOR . $this->item->filename; ?>
                    <a href="<?php echo JRoute::_(JUri::base() . $uploadPath, false); ?>"
                       target="_blank"><?php echo $this->item->filename; ?></a></td>
            </tr>
            <tr>
                <th><?php echo JText::_('COM_DB8DOWNLOAD_FORM_LBL_FILE_IMAGE'); ?></th>
