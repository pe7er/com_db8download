 ...
 * Db8download model.
 */
class Db8downloadModelUser extends JModelItem
{
	...
	public function &getData($id = null)
	{
		if ($this->_item === null)
		{
			...
			if (isset($this->_item->file) && $this->_item->file != '') {
				if(is_object($this->_item->file)){
					$this->_item->file = JArrayHelper::fromObject($this->_item->file);
				}
				$values = (is_array($this->_item->file)) ? $this->_item->file : explode(',',$this->_item->file);
			...
			$this->_item->file = !empty($textValue) ? implode(', ', $textValue) : $this->_item->file;
