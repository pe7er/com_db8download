...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_db8download&task=users.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_db8download&view=users'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'users.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_db8download&task=user.edit&id='.(int) $item->id); ?>">
