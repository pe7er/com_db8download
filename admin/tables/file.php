...
class Db8downloadTablefile extends JTable
{
			...
			if(empty($array['alias'])){
				...
				if(!empty($files['filename'])){
					...
					if($fileError > 0 && $fileError != 4) {
						...
						$uploadPath = JPATH_ADMINISTRATOR . '/components/com_db8download/db8downloads/' . $filename;
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_db8download');
	...
	jimport('joomla.filesystem.file');
	$result = JFile::delete(JPATH_ADMINISTRATOR . '/components/com_db8download/db8downloads/' . $this->filename);
		}
